...
% queue called all.q
gb_psom_qsub_options = '-S /bin/bash -q all.q'; 

% Options for the shell in batch or qsub modes
gb_psom_shell_options = ['source ' gb_psom_path_psom 'init_qsub_local.sh']; 
...
try
pkg local_list /home/mathieu/.octave_packages; 
pkg load image
